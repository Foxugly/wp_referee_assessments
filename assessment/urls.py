...
urlpatterns = [
	...
	path('assessment_referee/', login_required(superuser_only(AssessmentRefereeListView.as_view())), name='assessmentreferee_list'),
	path('assessment_referee/add/', login_required(superuser_only(AssessmentRefereeCreateView.as_view())), name="assessmentreferee_add"),
	path('assessment_referee/<int:pk>/', login_required(superuser_only(AssessmentRefereeDetailView.as_view())), name="assessmentreferee_detail"),
	path('assessment_referee/<int:pk>/change/', login_required(superuser_only(AssessmentRefereeUpdateView.as_view())), name="assessmentreferee_change"),
	path('assessment_referee/<int:pk>/delete/', login_required(superuser_only(AssessmentRefereeDeleteView.as_view())), name="assessmentreferee_delete"),

	path('assessment_match/', login_required(superuser_only(AssessmentMatchListView.as_view())), name='assessmentmatch_list'),
	path('assessment_match/add/', login_required(superuser_only(AssessmentMatchCreateView.as_view())), name="assessmentmatch_add"),
	path('assessment_match/<int:pk>/', login_required(superuser_only(AssessmentMatchDetailView.as_view())), name="assessmentmatch_detail"),
	path('assessment_match/<int:pk>/change/', login_required(superuser_only(AssessmentMatchUpdateView.as_view())), name="assessmentmatch_change"),
	path('assessment_match/<int:pk>/delete/', login_required(superuser_only(AssessmentMatchDeleteView.as_view())), name="assessmentmatch_delete"),
